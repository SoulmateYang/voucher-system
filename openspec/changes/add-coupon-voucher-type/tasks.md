...
- [ ] 8.1 Start backend and verify POST /api/v1/batches creates coupon batch with all discount fields
- [ ] 8.2 Verify POST /api/v1/batches/issue creates vouchers with correct faceValue
- [ ] 8.3 Verify POST /api/v1/vouchers/confirm works for fixed-amount coupon, percentage coupon, and rejects below-minimum orders
- [ ] 8.4 Start admin frontend and walk through create coupon batch → issue → verify flow
- [ ] 8.5 Start H5 frontend and verify coupon list/detail display
